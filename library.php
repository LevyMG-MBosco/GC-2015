  ...
  <div class="row">
    ...
    <div class="col-xs-4">
      <div class="interior-nav">
        <ul class="nav">
          <span><li id="nav0" class="selected">Library</li></span>
          <span><li id="nav1">Sales Literature</li></span>
          <span><li id="nav2">Application Data Sheets</li></span>
          <span><li id="nav3">Technical Articles</li></span>
          <span><li id="nav4">Ads</li></span>
          <span><li id="nav5">Videos</li></span>
        </ul>
      </div>
    </div>
  </div>
