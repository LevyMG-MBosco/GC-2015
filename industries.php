    ...
    <div class="col-xs-12 col-sm-9">
      <div class="interior-content">
        <div class="section" id="section-0">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h1>Combining Experience & Enthusiasm<br /> to Serve You Better</h1>
            </div>
            <div class="col-xs-12 col-sm-9">
        ...
        <div class="section" id="section-1">
          <div class="row">
            <div class="col-xs-12">
              <img src='assets/imgs/Ammo-Header.jpg' />
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12">
              <h1>Ammunition Tooling & Firearms Manufacturing</h1>
            </div>
            <div class="col-xs-12 col-sm-9">
            ...
            <div class="col-xs-12 col-sm-3">
              <div class="pdf-wrap">
                <a href="assets/pdf/GCAmmoGrades.pdf" target="_blank">
                  <table><tbody><tr>
                    <td><img class="pdf-icon" src="assets/imgs/pdf.png" /></td>
                    <td valign="middle"><p class="pdf-filename">Ammunition Tooling Grades</p></td>
                  </tr></tbody></table>
                </a>
              </div>
            </div>
        ...
        <div class="section" id="section-2">
          <div class="row">
            <div class="col-xs-12">
              <img src='assets/imgs/CanTooling-Header.jpg' />
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12">
        ...
        <div class="section" id="section-3">
          <div class="row">
            <div class="col-xs-12">
              <img src='assets/imgs/FastenerTooling-Header.jpg' />
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12">
              <h1>Fastener Tooling</h1>
            </div>
            <div class="col-xs-12 col-sm-9">
        ...
        <div class="section" id="section-5">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-3">
              <div class="pdf-wrap">
                <a href="assets/pdf/GCFlowControl.pdf" target="_blank">
                  <table><tbody><tr>
                    <td><img class="pdf-icon" src="assets/imgs/pdf.png" /></td>
                    <td valign="middle"><p class="pdf-filename">Erosion/Corrosion Resistance in Flow Control</p></td>
                  </tr></tbody></table>
                </a>
              </div>
              <div class="pdf-wrap">
                <a href="assets/pdf/GCGenFixx.pdf" target="_blank">
                  <table><tbody><tr>
                    <td><img class="pdf-icon" src="assets/imgs/pdf.png" /></td>
                    <td valign="middle"><p class="pdf-filename">GenFixx&#153;: Joining Tungsten Carbide & Steel</p></td>
                  </tr></tbody></table>
                </a>
              </div>
            </div>
        ...
        <div class="section" id="section-6">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h1>PM Compaction Tooling</h1>
            </div>
            <div class="col-xs-12 col-sm-9">
              <p>As a major supplier of semi-finished tooling to the powder metals industry, our grades are Sinter-HIPed and feature high wear resistance and high fracture toughness. Additionally, our Wire Electrical Discharge Machining (EDM) grades are formulated to withstand wire and ram EDM, and are guaranteed not to crack.</p><p>Besides supplying standard C9-C14 grades, we offer a premium selection that includes:</p><ul>  <li>GC-813CT</li>  <li>GC-411CT</li>  <li>GC-612CT</li>  <li>GC-618T</li></ul><p>These grades offer enhanced performance due to their tungsten carbide crystalline structure and contain additives that increase their toughness, corrosion resistance and anti-galling characteristics.</p>
            </div>
            <div class="col-xs-12 col-sm-3">
              <div class="pdf-wrap">
                <a href="assets/pdf/GCPowderMetalTooling.pdf" target="_blank">
                  <table><tbody><tr>
                    <td><img class="pdf-icon" src="assets/imgs/pdf.png" /></td>
                    <td valign="middle"><p class="pdf-filename">Powder Metal Tooling (Wire EDM)</p></td>
                  </tr></tbody></table>
                </a>
              </div>
            </div>
        ...
        <div class="section" id="section-7">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-3">
              <div class="pdf-wrap">
                <a href="assets/pdf/GCRooftile.pdf" target="_blank">
                  <table><tbody><tr>
                    <td><img class="pdf-icon" src="assets/imgs/pdf.png" /></td>
                    <td valign="middle"><p class="pdf-filename">Rooftile Tooling</p></td>
                  </tr></tbody></table>
                </a>
              </div>
            </div>
        ...
        <div class="section" id="section-9">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h1>Rotary Tooling</h1>
            </div>
            <div class="col-xs-12 col-sm-9">
              <p>Our semi-finished rotary tool blanks ship ready for pointing, final fluting and finish grinding to customer specifications.</p><p>The products we supply include:</p><ul>  <li>Precision preforms with green-machined flutes & utility grinds</li>  <li>Straight blanks with stepped diameters ready to be turned from a blank into a finished end mill or drill</li></ul><p>Our combination of shaping skills and modern equipment can meet the most demanding specifications. That’s why you’ll find our grades used in a multitude of metal cutting applications that require:</p><ul>  <li>Excellent wear life</li>  <li>Superior corrosion resistance to grinding fluids</li></ul><p>For applications involving composite materials, we offer sub-micron, lower binder grades to prevent extreme abrasion.</p>
            </div>
            <div class="col-xs-12 col-sm-3">
              <!-- Section side content goes here -->
            </div>
        ...
        <div class="section" id="section-11">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h1>Specialty Tooling</h1>
            </div>
            <div class="col-xs-12 col-sm-9">
              <p>We offer tungsten carbide finished tooling for the production of boring bars, wear parts, and specialty components and parts. </p><p>Regardless of your particular application, our engineering and manufacturing know-how enables us to develop the ideal solution.</p>
            </div>
            <div class="col-xs-12 col-sm-3">
              <!-- Section side content goes here -->
            </div>
        ...
        <div class="section" id="section-13">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h1>Synthetic Diamond Manufacturing</h1>
            </div>
            <div class="col-xs-12 col-sm-9">
            ...
            <div class="col-xs-12 col-sm-3">
              <div class="pdf-wrap">
                <a href="assets/pdf/GCPCDSubstrates.pdf" target="_blank">
                  <table><tbody><tr>
                    <td><img class="pdf-icon" src="assets/imgs/pdf.png" /></td>
                    <td valign="middle"><p class="pdf-filename">PCD Substrates and Disks</p></td>
                  </tr></tbody></table>
                </a>
              </div>
            </div>
