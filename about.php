    ...
    <div class="col-xs-9">
      ...
      <div class="interior-content">
        <div class="section" id="section-0">
          <div class="row">
            <div class="col-xs-12">
              <img src='assets/imgs/About-HERO.jpg' />
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12">
    ...
    <div class="col-xs-3">
      ...
      <div class="interior-nav"><!--
        <ul id="nav" class="nav">
          ...
          <span><li class="selected"><a href="#section-0">About</a></li></span>
          <span><li><a href="#section-1">Veterans</a></li></span>
          <span><li><a href="#section-2">Premo Award</a></li></span>
          <span><li><a href="#section-3">Videos</a></li></span>
        </ul>-->
      </div>
    </div>
  </div>
